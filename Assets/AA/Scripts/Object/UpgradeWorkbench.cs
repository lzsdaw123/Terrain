...
public class UpgradeValue
{
    ...
    /// <returns></returns>
    public UpgradeValue(String _類型, GameObject gameObject, 部位[] _部位, int lvevl, float power, float price)
    {
        類型 = _類型;
        Object = gameObject;
        部位 = _部位;
...
public class 部位
{
    ...
    /// <param name="Price">價格</param>
    /// <returns></returns>
    public 部位(String _類型, GameObject[] partObject, int[] id, String[] partName, GameObject[] part, int[] lvevl, float[] power, float[] price)
    {
        類型 = _類型;
        ID = id;
        PartName = partName;
